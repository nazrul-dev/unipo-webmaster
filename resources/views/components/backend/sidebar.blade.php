<div class="flex justify-between text-gray-100 bg-gray-800 md:hidden">
    <!-- logo -->
    <a href="#" class="block p-4 font-bold text-white">Better Dev</a>
...
<div
    class="absolute inset-y-0 left-0 w-64 px-2 space-y-6 text-blue-100 transition duration-200 ease-in-out transform -translate-x-full bg-blue-800 sidebar py-7 md:relative md:translate-x-0">
