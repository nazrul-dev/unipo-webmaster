<div x-data="data()" class="breaks-all">
    ...
    @if ($Mode == 'Data')
        <div>
            <div class="flex md:flex-row flex-col items-center justify-between  mb-5">
                <h1 class="my-5 font-semibold">Data Program Studi </h1>
                <div class="flex items-center space-x-3">
                    ...
                    <button type="button" @click="ModeChange('Add')"
                        ...
                        <x-tabler icon="square-plus" class="text-gray-50 h-6" strokeWidth="1" /> <span>Prodi
                        </span>
                    </button>
                    <div class="flex items-center justify-center ">
                        <div class="relative text-gray-600 focus-within:text-gray-400">
                            ...
                            <input type="search" wire:model="search"
                                ...
                                placeholder="Cari Prodi..." autocomplete="off">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div
                        ...
                        <div class="-mt-10">
                            <div class="text-center">
                                <h1 class="text-xl font-bold tracking-widert">TIDAK ADA DATA PROGRAM STUDI</h1>
                                <span>Klik icon Tambah Jika Ingin <br>Menambah Program Studi</span>
                            </div>
                    ...
                    @foreach ($DataAll as $data)
                        <div class="bg-gray-50 border border-gray-200 rounded">
                            ...
                            <div class="text-center md:p-5 p-2">
                                ...
                                <h1 class="text-sm md:text-xl font-bold tracking-wider">{{ $data->faculty->alias }}
                                </h1>
                                <p class="text-gray-600 md:text-base text-xs">{{ $data->created_at->diffForHumans() }}
                                </p>
        ...
        <div>
            <form wire:submit.prevent="{{ $Mode == 'Add' ? 'store' : 'update' }}">
                <div class="flex items-center justify-between">
                    <h1 class="my-5 font-semibold">Program Studi <span x-text="Mode"></span> </h1>
                    <div class="flex items-center space-x-3">
                ...
                <div class="flex space-x-5">
                    <div class="w-2/3">
                        <div class="mb-5">
                            <label for="" class="block mb-3"> Pilih Fakultas </label>
                            <select wire:model="faculty_id" class="form-select w-full form-input px-4 py-1 rounded">
                                <option value="" class="text-gray-500" selected>Pilih Fakultas</option>
                            ...
                            <p class="block text-sm text-red-500 my-2">
                                @error('faculty_id') <span
                                    class="font-semibold break-normal">{{ $message }}</span> @enderror
                            </p>

                        </div>
                        <div class="mb-5">
                            <label for="" class="block mb-3"> Nama Program Studi</label>
                        ...
                        <div class="flex justify-start space-x-5">
                            <div class="w-1/2">
                                <div class="mb-5">
                                    <label for="" class="block mb-3"> Nama Singkatan Prodi </label>
                                    <input type="text" wire:model="alias" class="w-full form-input px-4 py-1 rounded">
                                    <p class="block text-sm text-red-500 my-2">
                                        @error('alias') <span
                                                class="font-semibold break-normal">{{ $message }}</span>
                                        @enderror
                                    </p>
                                </div>
                            </div>
                            <div class="w-1/2">
                                <div class="mb-5">
                                    <label for="" class="block mb-1"> Status Prodi </label>
                                    <label class="inline-flex items-center mt-3 mr-5">
                                        <input wire:model="active" type="checkbox"
                                            class="form-checkbox h-5 w-5 text-green-600" checked><span
                    ...
                    <div class="w-1/3">
                        ...
                        <div class="mb-5">
                            <label for="" class="block mb-3"> {{ $Mode == 'Edit' ? 'Ganti' : 'Tambah' }} Logo
                                Prodi
                            </label>
                            <div class="mb-5">
                                @if ($logo && in_array($logo->getClientOriginalExtension(), ['jpg', 'png', 'jpeg', 'gif']))
                                    <img class="w-full object-fill border-dashed h-40 border-2 border-gray-200 my-5"
                                        src="{{ $this->logo->temporaryUrl() }}">
                                @endif

                                <input type="file" wire:model="logo"
                                    class="py-2  border-2 w-full form-input px-4  rounded">
                                <p class="block text-sm text-red-500 my-2">
                                    @error('logo') <span class="font-semibold break-normal">{{ $message }}</span>
                                    @enderror
                                </p>
                            </div>
                        </div>
