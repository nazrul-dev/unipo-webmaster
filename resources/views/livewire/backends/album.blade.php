    ...
    @if ($Mode == 'Data')
        <div>
            <div class="flex md:flex-row flex-col items-center justify-between  mb-5">
                <h1 class="my-5 font-semibold">Data Album </h1>
                <div class="flex items-center space-x-3">
                    ...
                    <button type="button" @click="ModeChange('Add')"
                        ...
                        <x-tabler icon="square-plus" class="text-gray-50 h-6" strokeWidth="1" /> <span>Album
                        </span>
                    </button>
                    <div class="flex items-center justify-center ">
                        <div class="relative text-gray-600 focus-within:text-gray-400">
                            ...
                            <input type="search" wire:model="search"
                                ...
                                placeholder="Cari Album..." autocomplete="off">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div
                        ...
                        <div class="-mt-10">
                            <div class="text-center">
                                <h1 class="text-xl font-bold tracking-widert">TIDAK ADA DATA ALBUM</h1>
                                <span>Klik icon Tambah Jika Ingin <br>Menambah Album</span>
                            </div>
                ...
                <div class="grid md:grid-cols-3 grid-cols-2 md:gap-4 gap-2">
                    @foreach ($DataAll as $data)
                        <div class="bg-gray-50 border border-gray-200 rounded-lg overflow-hidden">
                            <img class="md:h-32 h-16 w-full object-cover border-b-2" src="{{ $data->paththumb }}"
                                alt="">
                            <div class="flex justify-center items-end px-2 pt-3  space-x-2 border-gray-700">
                                
                                <a href="{{route('backend.Galery', $data->id)}}" 
                                    class="flex items-center px-2 py-1 bg-blue-500 rounded hover:text-gray-100 hover:bg-blue-700 focus:outline-none">
                                    <x-tabler icon="squares-filled" class="text-gray-50  h-4 md:h-6" strokeWidth="1" /> <span class="md:text-base text-xs text-white">{{$data->galeries_count}} Galeri </span>
                                </a>
        ...
        <div>
            <form wire:submit.prevent="{{ $Mode == 'Add' ? 'store' : 'update' }}">
                <div class="flex items-center justify-between">
                    <h1 class="my-5 font-semibold">Album <span x-text="Mode"></span> </h1>
                    <div class="flex items-center space-x-3">
                ...
                <div class="flex space-x-5">
                    <div class="w-2/3">
                        <div class="mb-5">
                            <label for="" class="block mb-3"> Nama Album </label>
                        ...
                        <div class="mb-5">
                            <label for="" class="block mb-3"> Keterangan Album </label>
                            <textarea wire:model="content" class="form-textarea w-full rounded"
                                placeholder="Tuliskan Keterangan Album" rows="3"></textarea>
                    ...
                    <div class="w-1/3">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="mb-5">
                                @if ($thumb && in_array($thumb->getClientOriginalExtension(), ['jpg', 'png', 'jpeg', 'gif']))
                                    <img class="w-full object-fill border-dashed h-40 border-2 border-gray-200 my-5"
                                        src="{{ $this->thumb->temporaryUrl() }}">
                                @endif

                                <input type="file" wire:model="thumb"
                                    class="py-2  border-2 w-full form-input px-4  rounded">
                                <p class="block text-sm text-red-500 my-2">
                                    @error('thumb') <span class="font-semibold break-normal">{{ $message }}</span>
                                    @enderror
                                </p>
                            </div>
                        </div>
