                    ...
                    <div class="flex items-center justify-center ">
                        <div class="relative text-gray-600 focus-within:text-gray-400">
                            ...
                            <input type="search" wire:model="search"
                                ...
                                placeholder="Cari Fakultas..." autocomplete="off">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div>
            <form wire:submit.prevent="{{ $Mode == 'Add' ? 'store' : 'update' }}">
                <div class="flex items-center justify-between">
                    <h1 class="my-5 font-semibold">Fakultas <span x-text="Mode"></span> </h1>
                    <div class="flex items-center space-x-3">
                ...
                <div class="flex space-x-5">
                    <div class="w-2/3">
                        <div class="mb-5">
                            <label for="" class="block mb-3"> Nama Fakultas </label>
                        ...
                        <div class="flex justify-start space-x-5">
                            <div class="w-1/2">
                                <div class="mb-5">
                                    <label for="" class="block mb-3"> Nama Singkatan Fakultas </label>
                            ...
                            <div class="w-1/2">
                                <div class="mb-5">
                                    <label for="" class="block mb-1"> Status Fakultas </label>
                        ...
                        <div class="w-1/2 mx-auto">
                            ...
                            @if ($Mode == 'Edit')
                                @if ($oldlogo)
                                    <label for="" class="block mb-3"> Logo Fakultas </label>
