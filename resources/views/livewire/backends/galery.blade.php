<div x-data="data()">
    ...
    @if ($Mode == 'Data')
        <div>
            <div class="flex md:flex-row flex-col items-center justify-between  mb-5">
                <h1 class="my-5 font-semibold">Data Galeri Album {{ $album->name }} </h1>
                <div class="flex items-center space-x-3">
                    <a href="{{ route('backend.Album') }}" type="button"
                        ...
                        <x-tabler icon="arrow-back-up" class="text-gray-50 h-6" strokeWidth="1" /> <span>Album
                        </span>
                    </a>
                    <button type="button" @click="ModeChange('Add')"
                        ...
                        <x-tabler icon="square-plus" class="text-gray-50 h-6" strokeWidth="1" /> <span>Galeri
                        </span>
                    </button>
                    <div class="flex items-center justify-center ">
                        <div class="relative text-gray-600 focus-within:text-gray-400">
                            ...
                            <input type="search" wire:model="search"
                                ...
                                placeholder="Cari Galeri..." autocomplete="off">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div
                        ...
                        <div class="-mt-10">
                            <div class="text-center">
                                <h1 class="text-xl font-bold tracking-widert">TIDAK ADA DATA GALERI</h1>
                                <span>Klik icon Tambah Jika Ingin <br>Menambah Galeri</span>
                            </div>
        ...
        <div>
            <form wire:submit.prevent="{{ $Mode == 'Add' ? 'store' : 'update' }}">
                <div class="flex items-center justify-between">
                    <h1 class="my-5 font-semibold">Galeri <span x-text="Mode"></span> </h1>
                    <div class="flex items-center space-x-3">
                ...
                <div class="flex space-x-5">
                    <div class="w-2/3">
                        <div class="mb-5">
                            <label for="" class="block mb-3"> Nama Galeri </label>
                        ...
                        <div class="mb-5">
                            <label for="" class="block mb-3"> Keterangan Galeri </label>
                            <textarea wire:model="content" class="form-textarea w-full rounded"
                                placeholder="Tuliskan Keterangan Galeri" rows="3"></textarea>
                        ...
                        <div class="w-1/2 mx-auto">
                            ...
                            @if ($Mode == 'Edit')
                                @if ($oldimage)
                                    <label for="" class="block mb-3"> Gambar Galeri </label>
    ...
    <div x-show="ModalView">
        <x-image-view ><img class="w-full object-fill" :src="pathImage" alt=""></x-image-view>
    </div>
