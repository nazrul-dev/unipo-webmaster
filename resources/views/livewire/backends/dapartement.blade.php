    ...
    @if ($Mode == 'Data')
        <div>
            <div class="flex md:flex-row flex-col items-center justify-between  mb-5">
                <h1 class="my-5 font-semibold">Data Dapartement </h1>
                <div class="flex items-center space-x-3">
                    ...
                    <button type="button" @click="ModeChange('Add')"
                        ...
                        <x-tabler icon="square-plus" class="text-gray-50 h-6" strokeWidth="1" /> <span>Dapartement
                        </span>
                    </button>
                    <div class="flex items-center justify-center ">
                        <div class="relative text-gray-600 focus-within:text-gray-400">
                            ...
                            <input type="search" wire:model="search"
                                ...
                                placeholder="Cari Dapartement..." autocomplete="off">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div
                        ...
                        <div class="-mt-10">
                            <div class="text-center">
                                <h1 class="text-xl font-bold tracking-widert">TIDAK ADA DATA DAPARTEMEN</h1>
                                <span>Klik icon Tambah Jika Ingin <br>Menambah Dapartement</span>
                            </div>
        ...
        <div>
            <form wire:submit.prevent="{{ $Mode == 'Add' ? 'store' : 'update' }}">
                <div class="flex items-center justify-between">
                    <h1 class="my-5 font-semibold">Dapartement <span x-text="Mode"></span> </h1>
                    <div class="flex items-center space-x-3">
                ...
                <div class="w-2/3">
                    <div class="mb-5">
                        <label for="" class="block mb-3"> Nama Dapartement </label>
                ...
                <div class="w-1/3">
                    <div class="mb-5">
                        <label for="" class="block mb-3"> Posisi </label>
                        <input type="number" wire:model="position" class="w-full form-input px-4 py-1 rounded">
                        <p class="block text-sm text-red-500 my-2">
                            @error('position') <span class="font-semibold break-normal">{{ $message }}</span>
                            @enderror
                        </p>
                    </div>
                </div>
