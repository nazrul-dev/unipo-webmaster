    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5  mx-auto">
            <div class="flex flex-col text-center w-full mb-20">
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Album asasasasas Universitas
                    Pohuwato</h1>
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Album Dari <br></p>
            </div>
                    ...
                    <div class="lg:w-1/3 sm:w-1/2 p-4">
                        <div class="flex relative">
                            <img alt="gallery" class="absolute inset-0 w-full h-full object-cover object-center"
                                src="{{ $galery->pathimage }}">
                            <div
                                class="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">

                                <h1 class="title-font text-lg font-medium text-gray-900 ">{{ $galery->name }}</h1>
                                <p class="leading-relaxed">{{ $galery->content }}</p>
                                <div class="flex justify-start space-x-3 my-5">
                                    <a href="javascript:void(0)"
                                        ...
                                        <x-tabler icon="squares-filled" class="text-gray-50  h-4 md:h-6"
                                            strokeWidth="1" /> <span
                                            class="md:text-base text-xs text-white">{{ $galery->galeries_count }} Total
                                            Galeri </span>
                                    </a>
                                    <a href="{{route('frontend.galery', $galery->id)}}"
